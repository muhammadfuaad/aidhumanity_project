...
function Appeals_options() {
  return (
    <div className="w-full mx-auto border border-black flex flex-col rounded-3xl relative">
      <div className="absolute -top-4 w-full">
        <img src="./icons/blue-bar.svg" className="w-full"></img>
        <img src="./icons/triangle-up.png" className="absolute -top-4 left-[43rem]"></img>
      </div>
      <div class="bg-white px-28 py-20 h-[40rem] flex gap-10 relative overflow-hidden rounded-t-3xl">
